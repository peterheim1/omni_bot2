...
class ArmDriver(Node):
    ...
    def __init__(self):
        ...
        self._SerialDataGateway = SerialDataGateway("/dev/ttyACM1", 57600, self._HandleReceivedLine)
        ...
        self.groups = {
            "right": ["j0_joint", "right_j1_joint", "right_j2_joint", "right_j3_joint", "right_j4_joint", "right_j5_joint"],
            "left":  ["left_j1_joint", "left_j2_joint", "left_j3_joint", "left_j4_joint", "left_j5_joint"],
            "head":  ["head_yaw_joint", "head_pitch_joint", "ear_joint"],
            "grippers": ["right_gripper_joint", "left_gripper_joint"]
        }
